...
module.exports = function (grunt) {
  ...
  grunt.registerTask('bookmarklet', 'Create Bookmarklet', function () {
    ...
    grunt.log.writeln(
      '├── source size: ' + 
      (source.length / 1024).toFixed(2) + ' kb'
    );
    grunt.log.writeln(
      '└── bookmarklet size: ' + 
      (bookmarklet_source.length / 1024).toFixed(2) + ' kb'
    );
  ...
  grunt.registerHelper('bookmarklet', function (text, wrap) {
    ...
    var 
      lines, len_lines, line, quotes, len_quotes, 
      removeEmptyChars, removeComments, textLength, j, i
    ;
